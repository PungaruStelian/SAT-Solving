...
1. Evaluarea leneșă permite generarea interpretărilor doar când sunt necesare.
Funcția any oprește procesul imediat ce găsește o interpretare care satisface formula,
fără a calcula restul interpretărilor posibile. Acest comportament economisește
semnificativ resurse de calcul pentru formule satisfiabile.

2. Dacă interpretations ar fi returnat un Set, toate interpretările ar fi fost generate complet
înainte de a începe verificarea satisfiabilității, pentru că Set în Haskell este o structură
strictă. Aceasta ar fi eliminat avantajul evaluării leneșe, forțând calculul tuturor
interpretărilor posibile chiar dacă soluția s-ar fi găsit la început.
